        ...
        setRoot(root) {
          ...
          if (metadata) {
            (_a2 = metadata[$refTypeFieldIndexes]) == null ? void 0 : _a2.forEach((index) => {
              var _a3;
              const field = metadata[index];
              const changeTree = (_a3 = this.ref[field.name]) == null ? void 0 : _a3[$changes];
              if (changeTree) {
...
Check @type() annotation`);
      ...
      const _Schema = class _Schema {
        ...
        static debugRefIds(ref, showContents = false, level = 0) {
          ...
          const refCount = ((_b2 = (_a2 = changeTree.root) == null ? void 0 : _a2.refCount) == null ? void 0 : _b2[refId]) > 1 ? ` [×${changeTree.root.refCount[refId]}]` : "";
